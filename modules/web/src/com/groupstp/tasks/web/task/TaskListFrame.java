...
import static com.groupstp.tasks.web.task.TaskList.CONTROLTASK;
import static com.groupstp.tasks.web.task.TaskList.MYTASK;
...
public class TaskListFrame extends AbstractFrame {
    ...
    @WindowParam(name = TaskList.FRAME_PARAMETR)
